...
def Q_Newton(f, f1, f2, a01, a02, eps, step):
    """
    Quasi Newton function without backtracking for optimization.
    ...
    Notes:
    - The function uses Quasi-Newton, an iterative optimization method, for variable optimization without backtracking.
